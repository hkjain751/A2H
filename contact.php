...
<head>
<title>BooksForYou|Contact</title>
      ...
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            ...
            <div class="clr"></div>
            <p>For Any Sugessions,Performance,Problems or any Other.Plese Send Us Feedback.</p>
          </div>
          <div class="article">
            ...
            <form action="#" method="post" id="sendemail">
              <ol>
                ...
                <li>
                  ...
                  <form>
                  <input type="button" value="Submit" onclick="window.location.href='thanks.html'"/>
                  </form>
        		</li>
