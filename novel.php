<?php
session_start();
$_SESSION['mylink']="novel.php";
$con = mysqli_connect('localhost','root','','mytest')
 or die('Error connecting to MySQL server.');
 $q="select bookid,bookimg,booktitle,price from bookdatabase where bookid LIKE 'n%'";
      ...
      <div class="content_bg">
            ...
            <p> <?php
			    if($num>=1)
				 ...
				 for($i=1;$i<=$num;$i++)
				 {
				   ...
				   echo $row['bookimg'];
				   ?>
				   " id="$row['bookid']" name="image"  border="1" style="border-color: #000000;" width="80" height="90" align="left"/>
				   <?php
				   echo "<br><h3><b>".$row['booktitle']."</b></h3>";
				   echo "<br>";
				 ...
				 <center><button class="button" style="vertical-align:middle" name="button1" value="<?php echo $id; ?>" onclick="window.location.href='cartadder.php'" style="width:120px; height:30px; background-color: #F5C810; border: #000000,thin; ">
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <div class="clr"></div>
            <ul class="sb_menu">
              <li class="active"><a href="novel.php">Novels</a></li>
