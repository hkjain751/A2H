<?php
session_start();
$_SESSION['mylink']="competative.php";
$con = mysqli_connect('localhost','root','','mytest')
 or die('Error connecting to MySQL server.');
 $q="select bookid,bookimg,booktitle,price from bookdatabase where bookid LIKE 'cmp%'";
...
<title>BooksForYou | Competative Books</title>
  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Competative Exam Books :</span></h2>
            <div class="clr"></div>
            <p> <?php
			    if($num>=1)
				 {
				 ...
				 for($i=1;$i<=$num;$i++)
				 {
				   ...
				   echo $row['bookimg'];
				   ?>
				   " id="$row['bookid']" name="image"  border="1" style="border-color:#000000" width="150" height="200" />
				   <?php
				   echo "<br><br><h3><b>".$row['booktitle']."</b></h3>";
				   echo "<br>";
				   ...
				   <button class="button" style="vertical-align:middle" name="button1" value="<?php echo $id; ?>" onclick="window.location.href='cartadder.php'" style="width:120px; height:30px; background-color: #F5C810; border: #000000,thin; "><span>Add To Cart</span></button></form>
				   <?php
				 }
 				 }
			    else
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li  class="active"><a href="competative.php">Competative Exam Books</a></li>
