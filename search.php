...
header("location:index.php");
 ...
 $q="select * from bookdatabase where booktitle LIKE '%$key%'";
...
<title>BooksForYou|Search</title>
...
<div id="templatemo_wrapper">
	...
	<div id="tempaltemo_header">
    	...
    	<div id="header_content">
        	<div id="site_title">
				<a href="#" target="_parent"><img src="bnlogo.jpg" alt="" height="160" width="800"/></a> 
				           </div>
            ...
            <p> <?php
			    if($num>=1)
				 ...
				 for($i=1;$i<=$num;$i++)
				 {
				   ...
				   <center>
				   <button class="button" style="vertical-align:middle" name="button1" value="<?php echo $id; ?>" ><span>Add To Cart</span></button>
				   </center></form>
				   	<br /><hr />
				   <?php
				 }
