<?php
session_start();
$_SESSION['mylink']="skills.php";
$con = mysqli_connect('localhost','root','','mytest')
 or die('Error connecting to MySQL server.');
 $q="select bookid,bookimg,booktitle,price from bookdatabase where bookid LIKE 'skl%'";
...
<title>BooksForYou | Skill Books</title>
            ...
            <p> <?php
			    if($num>=1)
				 ...
				 for($i=1;$i<=$num;$i++)
				 {
				   ...
				   <center><button class="button" style="vertical-align:middle" name="button1" value="<?php echo $id; ?>" onclick="window.location.href='cartadder.php'"><span>Add To Cart</span></button></center></form>
				   	<br /><hr />
				   <?php
				 }
 				 }
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="skills.php">Books for Skills</a></li>
