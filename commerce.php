<?php
session_start();
$_SESSION['mylink']="commerce.php";
$con = mysqli_connect('localhost','root','','mytest')
 or die('Error connecting to MySQL server.');
 $q="select bookid,bookimg,booktitle,price from bookdatabase where bookid LIKE 'com%'";
...
<title>BooksForYou | Commerce/Account Books</title>
  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Commerce/Account Field Books :</span></h2>
            <div class="clr"></div>
            <p> <?php
			    if($num>=1)
				 {
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="commerce.php">Commerce Books</a></li>
