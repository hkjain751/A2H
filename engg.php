<?php
session_start();
$_SESSION['mylink']="engg.php";
$con = mysqli_connect('localhost','root','','mytest')
 or die('Error connecting to MySQL server.');
 $q="select bookid,bookimg,booktitle,price from bookdatabase where bookid LIKE 'e%'";
...
<title>BooksForYou | Engg. Books</title>
  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>ENGINEERING BOOKS :</span></h2>
            <div class="clr"></div>
            <p> <?php
			    if($num>=1)
				 {
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="engg.php">Engg.Books</a></li>
